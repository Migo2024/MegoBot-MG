...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `*[❗معلومه❗] حط رابط الفيديو مثال: ${usedPrefix + command}* https://www.facebook.com/share/r/nSHfkca4YFkZY2Pv/?mibextid=oFDknk`;
  if (!args[0].match(/www.facebook.com|fb.watch/g)) throw `*[❗𝐈𝐍𝐅𝐎❗] حط رابط الفيديو مثال: ${usedPrefix + command}* https://www.facebook.com/share/r/nSHfkca4YFkZY2Pv/?mibextid=oFDknk`;
  try {
